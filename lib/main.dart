            ...
            if (snapshot.hasData) {
              return Column(
                ...
                children: [
                          ...
                          builder: (BuildContext context) {
                            ...
                            return AlertDialog(
                              ...
                              content: TextField(
                                onChanged: (value) {
                                  userInput =
                                      value; // Guardar el texto ingresado
                                },
                              ...
                              actions: <Widget>[
                                TextButton(
                                  child: Text('Guardar'),
                                  onPressed: () {
                                    nuevaTarea = Tarea(listadeTareas.length + 1,
                                        '$userInput', false);
                  ...
                  SizedBox(
                      height: 50), // Espacio entre el botón y el borde inferior
                ],
              );
            }
        ...
        itemBuilder: (BuildContext context, int index) {
          return ListTile(
            title: Row(
              children: [
                Container(
                  width: 50, // Ancho predefinido para el índice
                ...
                Container(
                  width: 200, // Ancho predefinido para el nombre
                  decoration: BoxDecoration(
                    border: Border.all(), // Borde para visualización
                  ),
                  child: Center(
